...
output "opensearch_collection_arn" {
  ...
  value       = local.create_opensearch ? aws_opensearchserverless_collection.this[0].arn : null
}

output "opensearch_collection_endpoint" {
  description = "Endpoint of the OpenSearch Serverless collection."
  value       = local.create_opensearch ? aws_opensearchserverless_collection.this[0].collection_endpoint : null
}

output "opensearch_dashboard_endpoint" {
  description = "Dashboard endpoint of the OpenSearch Serverless collection."
  value       = local.create_opensearch ? aws_opensearchserverless_collection.this[0].dashboard_endpoint : null
}
